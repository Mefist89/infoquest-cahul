...
const copy = {
  ru: {
    ...
    modules: "Прохождение модулей", moduleHint: "Сейчас доступна первая миссия. Остальные откроются позже.", open: "Открыть модуль", locked: "Скоро", score: "Результат", noScore: "—",
  ...
  ro: {
    ...
    modules: "Progresul modulelor", moduleHint: "Acum este disponibilă prima misiune. Celelalte se vor deschide mai târziu.", open: "Deschide modulul", locked: "În curând", score: "Rezultat", noScore: "—",
