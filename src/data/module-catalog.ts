...
export const MODULE_CATALOG = [
  ...
  },
  {
    ...
    icon: "user-lock",
    side: "left",
    category: { ro: "Conturi", ru: "Аккаунты" },
  ...
  },
  {
    ...
    icon: "gift",
    side: "left",
    category: { ro: "Oferte", ru: "Предложения" },
  ...
  },
  {
    ...
    icon: "scan-face",
    side: "right",
    category: { ro: "Deepfake-uri", ru: "Дипфейки" },
  ...
  },
  {
    ...
    icon: "languages",
    side: "right",
    category: { ro: "Traduceri", ru: "Переводы" },
